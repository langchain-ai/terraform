...
resource "google_storage_bucket" "object_store" {
  ...
  # No versioning and no object-expiry lifecycle rules on purpose. SmithDB owns
  # the lifecycle of its own objects; expiring or deleting live segments out from
  # under it makes data unavailable. Compaction already reclaims dead segments.
  #
