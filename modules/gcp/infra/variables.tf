...
# Unlike enable_deployments and enable_agent_builder above, no Terraform resource
# reads this one — Insights needs no GCP-side infrastructure. helm/scripts/deploy.sh
# and init-values.sh parse it out of terraform.tfvars to pick the values overlay.
# tflint-ignore: terraform_unused_declarations
