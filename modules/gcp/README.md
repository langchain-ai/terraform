...
### Cloud SQL module
This module will create a private or public Cloud SQL PostgreSQL instance. The default instance tier is `db-custom-2-8192` which has 2 vCPUs and 8 GB of memory. High availability can be enabled for production workloads. Storage size and other configurations are customizable via module variables.
