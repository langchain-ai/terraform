...
> **Releases:** when this module ships, deploy from the latest `v0.17.*` release tag, not `main`. Tags pin the LangSmith chart line (`~0.17.0` = latest `0.17.x`). See [Versioning and releases](../../README.md#versioning-and-releases).
