...
Absolute floor. Keeps LangSmith alive at the lowest possible cost. Fits on a single small node (e.g. Standard_D4s_v3 — 4 vCPU, 16Gi). Will break under any meaningful traffic.
