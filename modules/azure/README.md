...
| **Optional** | SmithDB Azure infrastructure (`enable_smithdb = true`) — needs chart 0.17.0-rc.29+ on the 0.17 line; see [SMITHDB.md](SMITHDB.md#version-requirements) | `terraform -chdir=infra apply` | ~15–30 min |
